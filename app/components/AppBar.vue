...
<template>
  <header
    class="transition-all fixed top-8 left-1/2 -translate-x-1/2 container py-4 px-6 bg-white rounded-md flex items-center justify-between border border-stroke"
    :class="{
